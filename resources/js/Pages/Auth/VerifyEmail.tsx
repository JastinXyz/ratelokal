      ...
      <form onSubmit={onSubmit}>
        <div className="mt-4 flex items-center justify-between">
          ...
          <Link
            ...
            method="post"
            as="button"
            className="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-offset-gray-800 ml-2"
          >
            Log Out
          </Link>
        </div>
