      ...
      <div className="min-h-screen bg-[#F3F4F6]">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-4">
            <div>
              <div className="w-full md:px-0 bg-white py-12 px-4 rounded-lg shadow">
                {/* Updated Text */}
                  ...
                  <div key={idx}>
                    <div className="bg-white rounded-lg p-4 shadow overflow-hidden h-full">
                      ...
                      <div className="mt-4 flex flex-col gap-1">
                        <a target="_blank" href={`https://wa.me/${x.whatsapp_number}`}><PrimaryButton className="w-full flex gap-2"><RiWhatsappLine className="text-white w-4 h-4" /> <span>Whatsapp</span></PrimaryButton></a>
